...
import Image1 from "../../assets/ic1.png.png";
import Image2 from "../../assets/ic2.png.png";
import Image3 from "../../assets/ic3b.png.png";
import Image4 from "../../assets/ic4.png.png";
    ...
    <div className="flex flex-col relative mt-8 max-w-[1460px] m-auto px-[95px]">
      <div className=" flex gap-5 flex-col items-center text-center text-white">
        <h1 className="flex gap-10 items-center text-[56px] font-bold">
          ...
          <Image width={100} height={100} src={Rocket} alt="" />
        </h1>
